...
# 获取批次batch
train_dir = 'D:/deep_learning/Tourist_attraction_identification/input'  # 训练样本的读入路径，这里的input是input_data2中对训练图片进行分类得到的，当然，在create_record.py中也可以直接进行分类。
logs_train_dir = 'D:/deep_learning/Tourist_attraction_identification/save'  # logs存储路径
